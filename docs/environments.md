...
| `PSY777-week1-Wed.m4a` | 79.0 min | PSY 777, week 1 Wednesday, 2026-08-26 — the first lecture recorded (was `tate_1.m4a`). Low-disfluency speaker. Only `.m4a` source; exercises the decode-path penalty (bug 9). |
